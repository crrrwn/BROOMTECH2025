<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col">
    ...
    <nav v-if="!isAuthPage" class="bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-200/50 sticky top-0 z-50">
          ...
          <div class="flex items-center">
            <router-link to="/" class="flex items-center space-x-3 group">
              <img 
                ...
                alt="BroomTech Logo"
                class="w-10 h-10 rounded-full object-cover shadow-md border-2 border-[#3ED400] group-hover:scale-105 transition-transform duration-300"
              />
      ...
      <div v-if="mobileMenuOpen" class="md:hidden bg-white/95 backdrop-blur-md border-t border-gray-200/50 shadow-lg absolute w-full top-16 left-0 transition-all duration-300">
        <div class="px-4 py-6 space-y-3">
          <router-link to="/" class="block px-4 py-3 text-sm text-gray-700 hover:text-[#74E600] hover:bg-green-50 rounded-xl font-bold transition-colors">Home</router-link>
    ...
    <footer v-if="!isAuthPage" class="bg-[#05103B] text-white py-12 relative overflow-hidden text-sm border-t border-gray-800">
          ...
          <div class="md:col-span-2 space-y-4">
            <div class="flex items-center space-x-3">
              <img 
                src="https://scontent.fmnl7-2.fna.fbcdn.net/v/t1.15752-9/514071591_1252432816270252_1243204019946633211_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=9f807c&_nc_eui2=AeEne1_QgvnzPimBbfxq_loR-tDfpI8SJXz60N-kjxIlfByb9W5QUiBtwAWWz58nuc7ZAQLaDdcR5XLMXSyYpi5e&_nc_ohc=Z2MtLp4I_nIQ7kNvwGjEqRH&_nc_oc=AdlW1joxM16GAk8osLpxm86ruX_2cZ8qFxvWkKoFoGQW5UcUL3PiO6FB5KEvFBr0z1o&_nc_zt=23&_nc_ht=scontent.fmnl7-2.fna&oh=03_Q7cD4AE-HhtPzzzdURQul2Z4mlCen24maOimsa0KoTIw7wwBlQ&oe=695A82D2" 
                alt="BroomTech Logo"
                class="w-10 h-10 rounded-full object-cover border-2 border-[#74E600]"
              />
              <div class="flex flex-col">
