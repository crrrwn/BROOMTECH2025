<template>
  <div class="min-h-screen flex flex-col font-sans bg-gray-50">
    ...
    <section class="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#74E600]">
      ...
      <div class="absolute inset-0 bg-gradient-to-br from-[#A8EB12]/20 via-[#74E600]/25 to-[#3ED400]/20 z-20 pointer-events-none animate-pulse"></div>
      ...
      <div class="relative z-30 container mx-auto px-4 sm:px-6 text-center mt-10">
        <div class="inline-block p-6 sm:p-10 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl animate-fade-in-up">
          <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-4 leading-tight drop-shadow-xl">
            Fast & Reliable 
            <span class="block mt-2 text-[#A8EB12] drop-shadow-lg">
              Delivery Service
            </span>
          </h1>
          <p class="text-base sm:text-lg md:text-xl text-gray-100 mb-8 max-w-2xl mx-auto leading-relaxed drop-shadow-md font-medium">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <router-link 
              ...
              class="w-full sm:w-auto px-8 py-3 rounded-full border-2 border-white text-white font-bold hover:bg-white hover:text-[#74E600] transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Login
            </router-link>
            <router-link 
              ...
              class="w-full sm:w-auto px-8 py-3 rounded-full bg-white text-[#74E600] font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:bg-gray-100"
            >
              Get Started
            </router-link>
          </div>
    ...
    <section id="services-section" class="py-16 bg-gray-50 relative z-10">
    ...
    <section id="about-section" class="py-16 bg-white overflow-hidden relative z-10">
      <div class="container mx-auto px-4 sm:px-6 max-w-6xl">
    ...
    <section class="py-12 bg-[#05103B] text-white relative overflow-hidden z-10">
