<template>
  <div class="min-h-screen relative flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 overflow-hidden font-sans">
    ...
    <div class="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#A8EB12] rounded-full mix-blend-multiply filter blur-[100px] opacity-70 animate-pulse"></div>
    <div class="absolute bottom-0 right-0 translate-x-1/3 translate-y-1/3 w-[30rem] h-[30rem] bg-[#3ED400] rounded-full mix-blend-multiply filter blur-[120px] opacity-60 animate-pulse delay-1000"></div>
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#74E600] rounded-full mix-blend-multiply filter blur-[80px] opacity-40"></div>

    <div class="relative w-full max-w-lg bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white/50 p-8 sm:p-10 z-10">
      
      <button 
        @click="$router.push('/register')"
        class="absolute top-6 left-6 p-2 rounded-full text-gray-400 hover:text-[#00C851] hover:bg-green-50 transition-all duration-200"
      >
      ...
      <div class="text-center space-y-6">
        ...
        <div class="space-y-2">
          <h2 class="text-3xl font-extrabold text-gray-800 tracking-tight">Check your email</h2>
          <p class="text-gray-500">
            We've sent a verification link to
          </p>
          <div class="inline-block px-4 py-2 bg-gray-50 rounded-xl border border-gray-200 mt-2">
            <p class="text-lg font-bold text-[#00C851]">
              {{ email }}
            </p>
          </div>
        </div>
        <div class="py-6">
          <div class="flex flex-col items-center">
            ...
            <div class="text-5xl font-black tabular-nums tracking-tight" 
        ...
        <div class="pt-2">
          ...
          <button
            ...
            class="w-full py-4 px-6 rounded-full font-bold text-sm transition-all duration-300 shadow-md flex items-center justify-center"
        ...
        <div class="mt-6 border-t border-gray-100 pt-6">
          <router-link
            to="/login"
            class="inline-flex items-center text-sm font-bold text-[#00C851] hover:text-[#3ED400] transition-colors"
          >
